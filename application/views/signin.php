                ...
                <div class="form-container my-4">
                    <div class="panel">
                        ...
                        <div class="form-group">
                            <input type="text" autofocus class="form-control" id="emial" name="email"
...
<!--                            <div class="invalid-feedback">--><?php //echo display('enter_your_valid_email') ?><!--</div>-->
                        ...
                        <?php echo form_close() ?>
                       <p style="text-align:center"> Powered By <a href="https://edrictech.com.ng" target="_blank">Edric Tech</a></p>
                    </div>
