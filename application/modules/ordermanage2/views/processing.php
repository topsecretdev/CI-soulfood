                             ...
                             <div class="col-sm-12" id="findfood">
								...
								foreach($iteminfo as $item){
                                	...
                                	<tr>
                                        ...
                                        <td class="text-center"><?php echo $item->customer_type2;?></td>
                                        ...
                                        <a href="<?php echo base_url("ordermanage2/order/orderdetails/$item->order_id") ?>" class="btn btn-info btn-sm" data-toggle="tooltip" data-placement="left" title="Details"><i class="fa fa-eye" aria-hidden="true"></i></a>
                                         <?php endif; ?>
                                         <a href="<?php echo base_url("ordermanage2/order/posorderinvoice/$item->order_id") ?>" class="btn btn-success btn-sm" data-toggle="tooltip" data-placement="left" title="" data-original-title="Invoice"><i class="fa fa-window-restore" aria-hidden="true"></i></a>
                                        </td>
                                    </tr>
                                <?php } ?>
                                </tbody>
