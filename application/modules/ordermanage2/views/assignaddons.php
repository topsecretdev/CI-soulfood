                    ...
                    <tbody>
                        ...
                        <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>">
                            ...
                            <td class="center">
                                ...
                                <a href="<?php echo base_url("ordermanage2/menu_addons/assignaddonsdelete/$addonsmenu->row_id") ?>"
                    ...
                    <div class="col-sm-12 col-md-12">
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                ...
                                <?php echo  form_open('ordermanage2/menu_addons/assignaddonscreate') ?>
                                ...
                                <div class="form-group row">
                                    <label for="menuid"
                                        class="col-sm-4 col-form-label"><?php echo display('item_name2') ?><span class="text-danger">*</span></label>
                                    <div class="col-sm-8 customesl">
                                        <?php 
                                        if(empty($addonsmenulist)){$addonsmenulist = array('' => '--Select--');}
