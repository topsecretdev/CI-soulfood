    ...
    <div class="col-sm-12 col-md-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <?php echo form_open_multipart("ordermanage2/item_food/addgroupfood") ?>
                ...
                <div class="row">
                    <div class="col-lg-4">
                        ...
                        <div class="form-group row">
                            <label for="foodname" class="col-sm-4 col-form-label"><?php echo display('item_name2')?> <span class="text-danger">*</span></label>
                            <div class="col-sm-8">
                                <input name="foodname" class="form-control" type="text" placeholder="<?php echo display('item_name2')?>"
                                    id="foodname"
                            ...
                            <tbody id="mygroupitem">
                                ...
                                <tr id="test<?php echo $i;?>">
                                    <td><input name="itemidvid" class="itemidvid" type="hidden"
                                            value="<?php echo $inteminfo->variant2id.$inteminfo->menuid ?>"><input
                                    ...
                                    <td><input name="varientid[]" id="varientid" type="hidden"
                                            value="<?php echo $inteminfo->variant2id;?>"><?php echo $inteminfo->variant2Name; ?>
                                    </td>
                                    <td><input name="myprice" class="myprice" type="hidden"
                                            id="pr<?php echo $inteminfo->variant2id.$inteminfo->menuid ?>"
                                            value="<?php echo $inteminfo->price; ?>"><?php echo $inteminfo->price; ?>
                                    </td>
                                    <td class="itemmanage_box_w_100"><button
                                            onclick="decrese(<?php echo $i;?>,<?php echo $inteminfo->price; ?>,<?php echo $inteminfo->variant2id.$inteminfo->menuid ?>)"
                                            ...
                                            onclick="increse(<?php echo $i;?>,<?php echo $inteminfo->price; ?>,<?php echo $inteminfo->variant2id.$inteminfo->menuid ?>)"
...
<script src="<?php echo base_url('application/modules/ordermanage2/assets/js/addgroupitem_script.js'); ?>"
