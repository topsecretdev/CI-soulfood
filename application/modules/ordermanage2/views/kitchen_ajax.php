<link rel="stylesheet" type="text/css" href="<?php echo base_url('application/modules/ordermanage2/assets/css/kitchen_ajax.css'); ?>">
<div class="col-md-12">
...
<script src="<?php echo base_url('application/modules/ordermanage2/assets/js/orderlist.js'); ?>" type="text/javascript"></script>
