        ...
        <div class="card panel-bd ">
            <div class="card-header">
                ...
                <div class="panel-title">
                    ...
                    <a href="<?php echo base_url()?>ordermanage2/table-list" class="btn btn-success">
            ...
            <div class="card-body">
 					<?php echo  form_open('ordermanage2/restauranttable/createfloor',array('id'=>'typeurl')) ?>
...
<script src="<?php echo base_url('application/modules/ordermanage2/assets/js/tablefloor_script.js'); ?>" type="text/javascript"></script>
