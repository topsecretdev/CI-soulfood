    ...
    <div class="col-sm-12">
        ...
        <div class="card">
            ...
            <div class="card-header">
                ...
                <h4><?php echo display('food_list2') ?></h4>
                    ...
                    <tbody>
                        ...
                        <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>">
                            ...
                            <td class="center">
                                ...
                                <a href="<?php echo base_url("ordermanage2/item_food/addgroupfood/$fooditems->ProductsID") ?>"
                                ...
                                <a href="<?php echo base_url("ordermanage2/item_food/create/$fooditems->ProductsID") ?>"
                                ...
                                <a href="<?php echo base_url("ordermanage2/item_food/delete/$fooditems->ProductsID") ?>"
