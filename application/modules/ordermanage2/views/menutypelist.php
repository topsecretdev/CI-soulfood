                        ...
                        <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>">
                            ...
                            <td class="center">
                                ...
                                <input name="url" type="hidden" id="url_<?php echo $tmenu->menutypeid; ?>"
                                    value="<?php echo base_url("ordermanage2/item_food/updatemenufrm") ?>" />
                                ...
                                <a href="<?php echo base_url("ordermanage2/item_food/deletemenutype/$tmenu->menutypeid") ?>"
                    ...
                    <div class="col-sm-12 col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <?php echo  form_open_multipart('ordermanage2/item_food/menutypecreate') ?>
...
<script src="<?php echo base_url('application/modules/ordermanage2/assets/js/menutypelist_script.js'); ?>"
