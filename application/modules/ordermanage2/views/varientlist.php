    ...
    <div class="col-sm-12">
        <div class="card">
            <div class="card-header">
                <h4><?php echo display('variant2_list') ?>
                    <small class="float-right"> <?php if($this->permission->method('ordermanage2','create')->access()): ?>
                ...
                <table width="100%" id="exdatatable" class="datatable table table-striped table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>">
                            <td><?php echo $sl; ?></td>
                            <td><?php echo $varient->variant2Name; ?></td>
                            <td><?php echo $varient->ProductName; ?></td>
                            <td class="center">
                                <?php if($this->permission->method('ordermanage2','update')->access()): ?>

                                <a onclick="editvarient('<?php echo $varient->variant2id; ?>')"
                                ...
                                <a href="<?php echo base_url("ordermanage2/item_food/deletevarient/$varient->variant2id") ?>"
                    ...
                    <div class="col-sm-12 col-md-12">
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                ...
                                <?php echo  form_open('ordermanage2/item_food/varientcreate') ?>
                                <?php echo form_hidden('variant2id', (!empty($intinfo->variant2id)?$intinfo->variant2id:null)) ?>
                                <div class="form-group row">
                                    <label for="itemname"
                                        class="col-sm-4 col-form-label"><?php echo display('item_name2')?><span
...
<div id="edit" class="modal fade" role="dialog">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <div class="modal-header">
                <strong><?php echo display('variant2_edit');?></strong>
                <button type="button" class="close" data-dismiss="modal">&times;</button>
            </div>
