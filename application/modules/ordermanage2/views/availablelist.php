    ...
    <div class="col-sm-12">
        <div class="card">
            <div class="card-header">
                <h4><?php echo display('food_availablelist2') ?>
                    ...
                    <tbody>
                        ...
                        <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>">
                            ...
                            <td class="center">
                                ...
                                <a href="<?php echo base_url("ordermanage2/item_food/deleteavailable/$avail->availableID") ?>"
                    ...
                    <div class="col-sm-12 col-md-12">
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                ...
                                <?php echo  form_open('ordermanage2/item_food/availablecreate') ?>
                                <?php echo form_hidden('availableID', (!empty($intinfo->availableID)?$intinfo->availableID:null)) ?>
                                <div class="form-group row">
                                    <label for="itemname"
                                        class="col-sm-3 col-form-label"><?php echo display('item_name2') ?><span
