<link href="<?php echo base_url('application/modules/ordermanage2/assets/css/tablesetting.css'); ?>" rel="stylesheet" type="text/css"/>
...
<script src="<?php echo base_url('application/modules/ordermanage2/assets/js/tablesetting_script.js'); ?>" type="text/javascript"></script>