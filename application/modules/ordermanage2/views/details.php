            ...
            <div id="printableArea">
                <div class="card-body">
                    <div class="col-md-12">
                            ...
                            <div class="col-md-8">
                                <img src="<?php echo base_url();?><?php echo (file_exists($comsettinginfo->invoice_logo)?$comsettinginfo->invoice_logo:'application/modules/ordermanage2/assets/images/dum_ordermanage2_ivc.png')?>"
                                    class="img img-responsive height-mb" alt="">
                                <br>
                                <span
                                    class="label label-success-outline m-r-15 p-10"><?php echo display('bill2ing_from') ?></span>
                                <address class="mt-10">
                                ...
                                <?php if($bill2info->shipping_type==2||$bill2info->shipping_type==3){?>
                                <address class="mt-10">
                            ...
                            <div id="lextleftinvoice" class="col-md-4 " >
                                ...
                                <div class="m-b-15"><?php echo display('bill2ing_date') ?>:
                                    <?php echo $orderinfo->order_date;?></div>
                                <span class="label label-success-outline m-r-15"><?php echo display('bill2ing_to') ?></span>
                                <address class="mt-10">
                                ...
                                <?php if($bill2info->shipping_type==2){?>
                    ...
                    <div class="row">
                        <p class="col-sm-12">
                            <strong><?php echo display('customer_order2') ?>:</strong><br /><?php echo $orderinfo->customer_note;?>
                        </p>
                    </div>
                    <?php } ?>
                    <?php if($bill2info->shipping_type==2){?>
                    <div class="row">
                        <p class="col-sm-12">
                            <strong><?php echo display('customerpicktime') ?>:</strong><br /><?php echo $bill2info->delivarydate;?>
                        </p>
                    </div>
                    <?php } ?>
                    <hr>
                        ...
                        <table class="table table-fixed table-bordered table-hover bg-white" id="purchaseTable">
                            ...
                            <tbody>
								  ...
								  $totalamount=0;
									...
									foreach ($iteminfo as $item){
                                        ...
                                        <tr>
                                            ...
                                            <td class="center">
                                                 <?php
                                                        if ($this->permission->method('barsalereturn', 'delete')->access()) : ?>
                                                 <a href="<?php echo base_url("ordermanage2/order-delete/".html_escape($item->row_id)) ?>"
                                ...
                                <tr>
                                    ...
                                    <td class="text-right">
                                        <strong><?php if($currency->position==1){echo $currency->curr_icon;}?>
                                            <?php $servicecharge=0; if(empty($bill2info)){ echo $servicecharge;} else{echo $servicecharge=$bill2info->service_charge;} ?>
                                            <?php if($currency->position==2){echo $currency->curr_icon;}?> </strong>
                                    </td>
                                </tr>
