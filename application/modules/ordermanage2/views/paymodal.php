                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
							...
							?>
                                    ...
                                    <div class="col-md-4">
                                        <?php if($pointsys==1 && $membership2>1){
								...
								?>
                                        ...
                                        <?php } ?>
                                        <div class="form-group"
                                            style="padding-top:<?php if($pointsys==1 && $membership2>1){echo "35px";}else{ echo "39px";}?>">
                                ...
                                <div class="form-group text-right mt-3">
                                    <div class="col-sm-12 mt-15 pr-0 text-center">
                                        ...
                                        <?php  if($ismerge==1){
                                            if($duemerge==0){
                                            ?>
                                        <button type="button" id="duembill2"
                                            class="btn btn-success w-md m-b-5 m-r-5 col-sm-5"
                                            onclick="duemargebill2()"><?php echo display('due_marge');?></button>
                                        <?php } ?>
                                        <button type="button" id="paidbill2"
                                        ...
                                        <button type="button"
                                            class="btn btn-success w-md m-b-5 mt-2 mb-n3" id="pay_bill2"
    ...
    <script src="<?php echo base_url('application/modules/ordermanage2/assets/js/paymodal.js'); ?>"
