  ...
  <div class="col-md-6">
                                    <div class="info_part split-item" onclick="selectelement(this)" data-value="<?php echo $id; ?>">
                                        ...
                                        <div class="submit_area">                                            
                                            <button class="btn btn-clear" id="subpay-<?php echo $id;?>" onclick="paySuborder(this)" data-url="<?php echo base_url().'ordermanage2/order/paysuborder';?>"><?php echo display('pay_print')?></button>
                                        </div>
                                    </div>
                                </div>
                                   <?php                            
