	                    ...
	                    <div class="panel-body">
	                        <div class="row">
	                            <div class="col-sm-10 wpr_68 display-inlineblock">
	                                ...
	                                <br>
	                                <span class="label label-success-outline m-r-15 p-10" ><?php echo display('bill2ing_from') ?></span>
	                                <address class="mt-10">
	                            ...
	                            <div class="col-sm-2 text-left mb-display">
	                                ...
	                                <div class="m-b-15"><?php echo display('bill2ing_date') ?>: <?php echo $orderinfo->order_date;?></div>
                                ...
                                <?php $i=0; 
								  $totalamount=0;
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right"><strong><?php if($currency->position==1){echo $currency->curr_icon;}?>  <?php $discount=0; if(empty($bill2info)){ echo $discount;} else{echo $discount=$bill2info->discount;} ?> <?php if($currency->position==2){echo $currency->curr_icon;}?> </strong></td>
                                    </tr>
                                    <tr>
                                    	<td class="text-right" colspan="4"><strong><?php echo display('service_chrg')?><?php echo $sdr;?></strong></td>
                                        <td class="text-right"><strong><?php if($currency->position==1){echo $currency->curr_icon;}?> <?php $servicecharge=0; if(empty($bill2info)){ echo $servicecharge;} else{echo $servicecharge=$bill2info->service_charge;} ?> <?php if($currency->position==2){echo $currency->curr_icon;}?> </strong></td>
                                    </tr>
