                        ...
                        if (!empty($iteminfo->productvat)) {
                          ...
                          $up_productvat = 0;
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right"><?php if($this->permission->method('ordermanage2','delete')->access()){?><a class="btn btn-danger btn-sm btnrightalign" onclick="deletecart(<?php echo $item->row_id;?>,<?php echo $item->order_id;?>,<?php echo $item->menu_id?>,<?php echo $item->varientid?>,<?php echo $item->menuqty;?>)"><i class="ti-trash" aria-hidden="true"></i></a><?php } ?></td>
                                     </tr>
                                    <?php 
									if(!empty($item->add_on_id)){
										$y=0;
...
<table class="table table-bordered bg-white">
                                <?php $servicecharge=0;
                                            if(empty($bill2info)){
                                                ...
                                                ?>
                                            <?php $discount=0;
							$customerinfo=$this->order_model->read('*', 'customerinfo', array('customerid' =>$bill2info->customer_id));
