<link rel="stylesheet" type="text/css"
    href="<?php echo base_url('application/modules/ordermanage2/assets/css/onoing_ajax.css'); ?>">
<div class="col-md-12">
    <div class="row mb-2">
        <div class="col-sm-3">
            <select id="ongoingtable_name" onchange="ongoingtable_namesrc()" class="form-control dont-select-me  search-table-field" dir="ltr" name="s">
            </select>
        </div>
        <div class="col-sm-3">
    ...
    <div class="row">
        <?php 
									 ...
									 foreach($ongoingorder as $onprocess){
										 $bill2total=round($onprocess->totalamount-$onprocess->customerpaid);
        ...
        <div class="col-sm-4 col-md-3 col-xs-6 col-xlg-2">
            ...
            <div class="hero-widget well well-sm height-abg">
                <div class="mdjc">
                    ...
                    <?php if($this->permission->method('ordermanage2','update')->access() && $onprocess->splitpay_status ==0):?>
                    <div class="display-flex align-items-center">
                        <?php $margeinfo=$this->db->select('order_id')->from('customer_order2')->where('marge_order_id',$onprocess->marge_order_id)->get()->result();
									   $allmergeid="";
                ...
                <div>
                    ...
                    <?php if($this->permission->method('ordermanage2','delete')->access()){?>
                    ...
                    <a href="javascript:;"
                        ...
                        data-url="<?php echo base_url("ordermanage2/order/checkprintdue/".$onprocess->marge_order_id) ?>"
            ...
            <div class="hero-widget well well-sm height-auto">
                ...
                <div>
                    ...
                    <a href="javascript:;" onclick="createMargeorder(<?php echo $onprocess->order_id;?>,1)"
                        ...
                        data-placement="left"
                        data-url="<?php echo base_url("ordermanage2/order/dueinvoice/".$onprocess->order_id) ?>"
                        title="Due Invoice"><i class="fa fa-window-restore"></i></a>
                    <?php }
                        else{ ?>
                    <a href="javascript:;" onclick="showsplitmodal(<?php echo $onprocess->order_id;?>)"
...
<script src="<?php echo base_url('application/modules/ordermanage2/assets/js/ongoing.js'); ?>" type="text/javascript">
</script>