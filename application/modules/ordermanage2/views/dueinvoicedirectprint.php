...
<div class="page-wrapper">
  <div class="invoice-card">
    <div class="invoice-head"> <img src="<?php echo base_url();?><?php echo (file_exists($comsettinginfo->invoice_logo)?$comsettinginfo->invoice_logo:'application/modules/ordermanage2/assets/images/dum_ordermanage2_ivc.png')?>" alt="">
    ...
    <div class="invoice-footer mb-15">
      <div class="row-data">
        ...
        <h5 class="my-5">
          <?php if($currency->position==1){echo $currency->curr_icon;}?>
          <?php echo $bill2info->total_amount;?>
          <?php if($currency->position==2){echo $currency->curr_icon;}?>
        </h5>
      </div>
      ...
      <div class="row-data">
        ...
        <h5 class="my-5">
          <?php if($currency->position==1){echo $currency->curr_icon;}?>
          <?php $sdcharge=0; if(empty($bill2info)){ echo $sdcharge;} else{echo $sdcharge=$bill2info->service_charge;} ?>
          <?php if($currency->position==2){echo $currency->curr_icon;}?>
        </h5>
      </div>
      <div class="row-data">
        ...
        <h5 class="my-5">
          <?php if($currency->position==1){echo $currency->curr_icon;}?>
          <?php $discount=0; if(empty($bill2info)){ echo $discount;} else{echo $discount=$bill2info->discount;} ?>
          <?php if($currency->position==2){echo $currency->curr_icon;}?>
        </h5>
      </div>
      <div class="row-data border-top">
        ...
        <h5 class="my-5">
          <?php if($currency->position==1){echo $currency->curr_icon;}?>
          <?php echo $bill2info->bill2_amount;?>
          <?php if($currency->position==2){echo $currency->curr_icon;}?>
        </h5>
      </div>
      <?php 
      ...
      <div class="row-data">
        ...
        <h5 class="my-5">
          <?php if($bill2info->bill2_status==1){if($currency->position==1){echo $currency->curr_icon;} echo $customepaid; if($currency->position==2){echo $currency->curr_icon;} } else{ if($currency->position==1){echo $currency->curr_icon;} echo $customepaid;if($currency->position==2){echo $currency->curr_icon;} }?>
        </h5>
      </div>
    </div>
    <div class="invoice_address">
