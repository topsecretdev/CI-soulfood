...
<div id="items" class="modal fade" role="dialog">
 ...
 <form action="<?php echo base_url("ordermanage2/order/insert_customerord") ?>" class="form-vertical" id="validate" method="post" accept-charset="utf-8">
...
<div class="row">
        <div class="col-sm-12 col-md-12">
         <?php echo form_open_multipart('ordermanage2/order/placeoreder',array('class' => 'form-vertical', 'id' => 'insert_purchase','name' => 'insert_purchase'))?>
            <div class="panel panel-bd">
               <div class="panel-heading">
                ...
                <div class="panel-body">
                    ...
                    <input name="url" type="hidden" id="carturl" value="<?php echo base_url("ordermanage2/order/addtocart") ?>" />
                    <input name="url" type="hidden" id="cartupdateturl" value="<?php echo base_url("ordermanage2/order/cartupdate") ?>" />
                    ...
                    <input class="form-control" type="hidden" id="bill2_info" name="bill2_info" required value="1" />
					<div class="row">
                    ...
                    <div class="row">
                             <div class="col-sm-7">
                                <div class="form-group row">
                                    <label for="customertype" class="col-sm-4 col-form-label"><?php echo display('customer_type2');?> <i class="text-danger">*</i>
                                    </label>
                                    <div class="col-sm-6">
                                      <?php $ctyid=1;
						...
						echo form_dropdown('waiter',$waiterlist,(!empty($waiterlist->emp_his_id)?$waiterlist->emp_his_id:null),'class="form-control" id="waiter" required') ?>
                                ...
                                <div class="form-group row">
                                    <label for="date" class="col-sm-4 col-form-label"><?php echo display('customer_order2')?></label>
                                    <div class="col-sm-8">
                         	...
                         	<div class="bottomarea">
                                 <div class="row">
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <a href="<?php echo base_url("ordermanage2/order/cartclear") ?>" type="button" class="btn btn-danger cusbtn"><?php echo display('cancel')?></a>
  ...
  <script src="<?php echo base_url('application/modules/ordermanage2/assets/js/cashcounter.js'); ?>" type="text/javascript"></script>
