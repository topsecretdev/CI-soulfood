...
<div class="page-wrapper">
        <div class="invoice-card">
			...
			<div class="invoice_address">
                <div class="row-data">
                    <div class="item-info">
                        <h5 class="item-title"><?php echo display('date');?>: <?php echo date("M d, Y", strtotime($bill2date));?></h5>
                    </div>
			...
			$itemtotal=$totalamount+$subtotal;
							  ...
							  $vatcalc=0;
							  $b=0;
							  foreach($bill2info as $bill2){
								  if(!empty($taxinfos)){
								  $ordertaxinfo=$this->order_model->read('*', 'tax_collection', array('relation_id' => $bill2->order_id));
								  ...
								  $itemtotal=$bill2->totalamount;
								  $allsubtotal=$allsubtotal+$bill2->total_amount;
			 					  $singlevat=$bill2->VAT;
								  $calvat= $calvat+$singlevat;
								  $sdpr=$bill2->service_charge;
								  $servicecharge=$servicecharge+$sdpr;
								  $sdr=$bill2->discount;
								  $discount=$discount+$sdr;
								  $grandtotal=$grandtotal+$bill2->bill2_amount;
								  $allorder.=$bill2->order_id.',';
								  $b++;
								  }
