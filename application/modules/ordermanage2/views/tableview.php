    ...
    <div class="col-md-4">
        <div class="info_part <?php if($table['sum'] >= $table['person_capicity']){ echo 'booked';}?>">
            ...
            <table class="table table-bordered table-modal table-info text-center">
                <?php $table_count = count($table['table_details2']);?>
                ...
                <tbody id="table-tbody-<?php echo $table['tableid'];?>">
                    <?php if(!empty($table['table_details2'])){
                                                foreach ($table['table_details2'] as $table_details2) {
                                                ?>
                    <tr id="table-tr-<?php echo $table_details2->id; ?>">
                        <td scope="row"><?php echo $table_details2->order_id; ?></td>
                        <td><?php echo $table_details2->time_enter; ?></td>
                        <td><?php echo $table_details2->total_people; ?></td>
                        <td>
                            <button class="btn btn-del" onClick="deleterow_table(<?php echo $table_details2->id; ?>)"><i
