                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <div class="row no-gutters">
                                    ...
                                    <div class="col-md-4">
                                        <?php if(!empty($pointsys)){ if($pointsys==1 && $membership2>1){
                                    ...
                                    ?>
                                        ...
                                        <?php } }?>
                                        <div class="form-group"
                                            style="padding-top:<?php if(!empty($pointsys)){ if($pointsys==1 && $membership2>1){echo "35px";}else{ echo "28px";} }?>">
    ...
    <script src="<?php echo base_url('application/modules/ordermanage2/assets/js/suborder.js'); ?>"
