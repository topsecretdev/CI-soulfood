                ...
                <table width="100%" id="exdatatable" class="datatable table table-striped table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        <?php foreach ($categories as $category) {
								...
								$this->load->model('ordermanage2/category_model','categorymodel');
                        ...
                        <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>">
                            ...
                            <td class="center">
                                ...
                                <a href="<?php echo base_url("ordermanage2/item_category2/create/$category->CategoryID") ?>"
                                ...
                                <a href="<?php echo base_url("ordermanage2/item_category2/delete/$category->CategoryID") ?>"
