...
<head>
    ...
    if (pstatus == 0) {
        var returnurl = "<?php echo base_url('ordermanage2/order/pos_invoice'); ?>";
    } else {
        var returnurl =
            "<?php echo base_url('ordermanage2/order/pos_invoice'); ?>?tokenorder=<?php echo $orderinfo->order_id;?>";
    }
    window.print();
    ...
    <link rel="stylesheet" type="text/css"
        href="<?php echo base_url('application/modules/ordermanage2/assets/css/pos_token.css'); ?>">
</head>
                        ...
                        <td>
                            ...
                            <table width="100%">
                                ...
                                <tr>
                                    ...
                                    <td align="left"><?php echo $item->variant2Name;?></td>
                                </tr>
                                <?php 
										if(!empty($item->add_on_id)){
										$y=0;
									...
									if(!empty($exitsitem)) {
										...
										foreach ($exitsitem as $exititem){
											$isexitsitem=$this->order_model->readupdate('tbl_updateitems2.*,SUM(tbl_updateitems2.qty) as totalqty', 'tbl_updateitems2', array('ordid' =>$orderinfo->order_id,'menuid'=>$exititem->menu_id,'varientid'=>$exititem->varientid,'addonsuid'=>$exititem->addonsuid));
											...
											?>
												<tr>
													...
													<td align="left"><?php echo $exititem->variant2Name;?></td>
												</tr>
												<?php } }
											else{}
								}
