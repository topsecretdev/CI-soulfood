<div class="row">
    <div class="col-sm-12 col-md-12">
        <div class="card">
            ...
            <div class="card-body">
                <?php  echo form_open_multipart("ordermanage2/item_category2/create");?>
...
<script src="<?php echo base_url('application/modules/ordermanage2/assets/js/addcategory_script.js'); ?>"
