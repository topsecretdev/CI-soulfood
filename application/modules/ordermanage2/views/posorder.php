...
<script src="<?php echo base_url('application/modules/ordermanage2/assets/js/postop.js'); ?>" type="text/javascript">
                                  ...
                                  echo form_dropdown('card_typesl',$paymentmethod,(!empty($card_type)?$card_type:null),'class="postform resizeselect form-control" id="card_typesl"') ?>
                                    ...
                                    <div class="form-group text-right">
                                        ...
                                        <div class="col-sm-11 pr-0">
                                            ...
                                            <button type="button" id="paidbill2" class="btn btn-success w-md m-b-5"
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group row">
                    ...
                    <label for="name" class="col-sm-4 col-form-label"><?php echo display('customer_type2');?> <span class="text-danger">*</span></label>

                    <div class="col-sm-6">

                    <select class="basic-single" onchange="newcustdatares()" name="newcustomer_type2res" id="newcustomer_type2res">
                ...
                <ul class="nav nav-tabs mb-2" role="tablist">
                    ...
                    <li class="nav-item">
                        ...
                        <a href="#profile" role="tab" data-toggle="tab" class="nav-link ongord newtab" id="ongoingorder"
                            ...
                            onclick="giveselecttab(this),ongoingclick()"><i class="fa fa-hourglass-start smallview"></i> <span
                                ...
                                class="responsiveview"><?php echo display('ongoingorder');?></span> 
                    ...
                    <li class="nav-item"> 
                        ...
                        <a href="#messages" role="tab" data-toggle="tab" class="nav-link torder newtab" id="todayorder"
                            ...
                            <span class="responsiveview"><?php echo display('tdayorder');?></span> 
                        ...
                        <div class=" col-md-12">
                            ...
                            <div class="">
                                ...
                                <input name="url" type="hidden" id="carturl"
                                    ...
                                    value="<?php echo base_url("ordermanage2/order/posaddtocart") ?>" />
                                ...
                                <div class="row">
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div class="card-body p-2"> <img
                                                                        ...
                                                                        <input type="hidden" name="select_product_size"
                                                                            ...
                                                                            value="<?php echo $item->variant2id;?>">
                                                                    ...
                                                                    <div class="card-footer">
                                                                        ...
                                                                        <span
                                                                            ...
                                                                            class="positemfooter"><?php echo $item->ProductName;?>
                                    ...
                                    <div class="col-md-5">
                                        ...
                                        <form action="<?php echo base_url("ordermanage2/order/pos_order")?>"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 form-group">
                                                    ...
                                                    <label
                                                        ...
                                                        for="customer_name"><?php echo display('customer_name')."(".display('checkin').")";?><span
                                                    ...
                                                    <div class="d-flex">
                                                        ...
                                                        <?php $cusid=1;
                                                                    ...
                                                                    echo form_dropdown('customer_name',$customerlist,(!empty($cusid)?$cusid:null),'class="postform resizeselect form-control" onchange="ordercust()" id="customer_name" required') ?>
                                                ...
                                                <div class="row w-100 d-none" id="thirdparty">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" type="hidden" id="bill2_info"

                                                        name="bill2_info" required value="1" />
                                                        ...
                                                        <?php $grtotal=0;
                                                                    ...
                                                                    $totalitem=0;
                                                                     ...
                                                                     $itemtotal=0;
                                                                      ...
                                                                      $this->load->model('ordermanage2/order_model', 'ordermodel');
                                            ...
                                            <div class="fixedclasspos">
                                                ...
                                                <div class="row d-flex flex-wrap align-items-center">
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <div class="row m-0">
                                                                        ...
                                                                        <label for="date"
                                                                            ...
                                                                            class="col-sm-8 mb-0"><?php echo display('vat_tax1');if(!empty($settinginfo->vat)){echo '('.$settinginfo->vat.'%)';}?>:
                                                    ...
                                                    <div class="col-sm-6 text-right"> <a class="btn btn-primary cusbtn"
                                                            ...
                                                            href="<?php echo base_url("ordermanage2/order/posclear") ?>"
...
<script src="<?php echo base_url('ordermanage2/order/possettingjs') ?>" type="text/javascript"></script>

<script src="<?php echo base_url('ordermanage2/order/quickorderjs') ?>" type="text/javascript"></script>

<script src="<?php echo MOD_URL.$module;?>/assets/js/possetting.js?v==3" type="text/javascript"></script>
