                    ...
                    <div class="col-sm-12 col-md-12">
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                ...
                                <?php echo  form_open_multipart('ordermanage2/restauranttable/create') ?>
                            ...
                            <h4>My tables
                                <div class="btn-group float-right">
                                    ...
                                    <input name="url" type="hidden" id="uploadurl"
                                        value="<?php echo base_url("ordermanage2/restauranttable/uploadfile") ?>" />
...
<div class="row">
    ...
    <div class="col-sm-12">
        ...
        <div class="card panel-default thumbnail">
            <div class="card-header">
                <?php if($this->permission->method('ordermanage2','create')->access()): ?>
                <h4>
                    <?php echo display('table_list') ?>
                    <small class="float-right">
                        <a href="<?php echo base_url()?>ordermanage2/restauranttable/floorlist" class="btn btn-primary btn-md">
                        ...
                        <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>">
                            ...
                            <td class="center">
                                ...
                                <input name="url" type="hidden" id="url_<?php echo $table->tableid; ?>"
                                    value="<?php echo base_url("ordermanage2/restauranttable/updateintfrm") ?>" />
                                ...
                                <a href="<?php echo base_url("ordermanage2/restauranttable/delete/$table->tableid") ?>"
...
<script src="<?php echo base_url('application/modules/ordermanage2/assets/js/tablelist_script.js'); ?>"
