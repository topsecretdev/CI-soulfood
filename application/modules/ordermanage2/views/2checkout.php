...
<input type='hidden' name='x_receipt_link_url' value='<?php echo base_url();?>ordermanage2/order/successful2/' />
                                ...
                                <?php $i=0; 
								  $totalamount=0;
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right"><strong><?php if($currency->position==1){echo $currency->curr_icon;}?>  <?php $discount=0; if(empty($mybill2)){ echo $discount;} else{echo $discount=$mybill2->discount;} ?> <?php if($currency->position==2){echo $currency->curr_icon;}?> </strong></td>
                                    </tr>
                                    <tr>
                                    	<td class="text-right" colspan="4"><strong><?php echo display('service_charge');?></strong></td>
                                        <td class="text-right"><strong><?php if($currency->position==1){echo $currency->curr_icon;}?> <?php $servicecharge=0; if(empty($mybill2)){ echo $servicecharge;} else{echo $servicecharge=$mybill2->service_charge;} ?> <?php if($currency->position==2){echo $currency->curr_icon;}?> </strong></td>
                                    </tr>
                                    <tr>
