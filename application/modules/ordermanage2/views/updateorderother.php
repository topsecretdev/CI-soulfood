...
<link rel="stylesheet" type="text/css" href="<?php echo base_url('application/modules/ordermanage2/assets/css/posordernew.css'); ?>">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content display-none">
            <div class="modal-header">
                ...
                <h5 class="modal-title" id="exampleModalLabel"><?php echo display('foodnote2') ?></h5>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label class="control-label" for="user_email"><?php echo display('foodnote2') ?></label>
                            <textarea cols="45" rows="3" id="foodnote2" class="form-control" name="foodnote2"></textarea>
...
<div class="row">
    <div class="col-sm-12 col-md-12">
        <div class="">
            ...
            <input name="url" type="hidden" id="posurl_update" value="<?php echo base_url("ordermanage2/order/getitemlist") ?>" />
            <input name="url" type="hidden" id="productdata" value="<?php echo base_url("ordermanage2/order/getitemdata") ?>" />
            <input name="url" type="hidden" id="updatecarturl" value="<?php echo base_url("ordermanage2/order/addtocartupdate") ?>" />
            <input name="url" type="hidden" id="cartupdateturl" value="<?php echo base_url("ordermanage2/order/poscartupdate") ?>" />
            <input name="url" type="hidden" id="addonexsurl" value="<?php echo base_url("ordermanage2/order/posaddonsmenu") ?>" />
            <input name="url" type="hidden" id="removeurl" value="<?php echo base_url("ordermanage2/order/removetocart") ?>" />
            <div class="row">
                <div class="col-md-7">
                    <div class="row">
                        <div class="col-md-12">
                            <form class="navbar-search" method="get" action="<?php echo base_url("ordermanage2/order/pos_invoice")?>" >
                                    ...
                                    <div class="col-xs-6 col-sm-4 col-md-4 col-lg-3 col-p-3">
                                        <div class="card product-card positemcard update_select_product">
                                            <div class="card-body p-2" >
                                                ...
                                                <input type="hidden" name="update_select_product_size" class="select_product_size" value="<?php echo $item->variant2id;?>">
                                                ...
                                                <input type="hidden" name="select_varient_name" class="update_select_varient_name" value="<?php echo $item->variant2Name;?>">
                                            ...
                                            <div class="card-footer"><span><?php echo $item->ProductName;?> (<?php echo $item->variant2Name;?>)<?php if(!empty($item->itemnotes)){ echo " -".$item->itemnotes;}?></span></div>
                                        </div>
                                    </div>
                                    <?php } ?>
                                </div>
                ...
                <div class="col-md-5">
                    ...
                    <input name="url" type="hidden" id="url" value="<?php echo base_url("ordermanage2/order/itemlistselect") ?>" />
                    <input name="url" type="hidden" id="addonsurl" value="<?php echo base_url("ordermanage2/order/addonsmenu") ?>" />
                    <input name="url" type="hidden" id="updatecarturl" value="<?php echo base_url("ordermanage2/order/addtocartupdate") ?>" />
                    <input name="url" type="hidden" id="delurl" value="<?php echo base_url("ordermanage2/order/deletetocart") ?>" />
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 form-group">
                            <label for="store_id"><?php echo display('customer_type2');?> <span class="color-red">*</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
                            <?php $ctype=1;
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="hidden" id="bill2_info" name="bill2_info" required value="<?php echo $bill2info->bill2_status;?>" />
                            <input type="hidden" id="card_type" name="card_type" value="<?php echo $bill2info->payment_method_id;?>" />
                            ...
                            <table class="table table-bordered bg-white">
                                <tr>
                                    ...
                                    <td class="text-right wpr_28">
                                        ...
                                        $servicecharge=$bill2info->service_charge;
                                        }
                                        else{
                                        $servicecharge=$bill2info->service_charge*100/$bill2info->total_amount;
                                        }
                                        $sdamount=$bill2info->service_charge;
                                        }
                                        ?>
                                        <?php $discount=0;
...
<script src="<?php echo base_url('ordermanage2/order/updateorderjs/'.$orderinfo->order_id) ?>" type="text/javascript"></script>
<script src="<?php echo base_url('application/modules/ordermanage2/assets/js/posupdateother.js'); ?>" type="text/javascript"></script>
<script>
