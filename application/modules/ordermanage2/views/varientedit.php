                ...
                <div class="panel-body">
                    ...
                    <?php echo form_open('ordermanage2/item_food/varientcreate'); ?>
                   	<?php echo form_hidden('variant2id', (!empty($intinfo->variant2id)?$intinfo->variant2id:null)) ?>
                        ...
                        <label for="itemname" class="col-sm-4 col-form-label"><?php echo display('item_name2') ?><span class="text-danger">*</span></label>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input name="varientname" class="form-control" type="text" placeholder="<?php echo display('add_varient') ?>" id="unitname" value="<?php echo (!empty($intinfo->variant2Name)?$intinfo->variant2Name:null) ?>">
                            </div>
                        </div>
                        <div class="form-group row">
