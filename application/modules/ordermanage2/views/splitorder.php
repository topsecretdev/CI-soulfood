<link rel="stylesheet" type="text/css" href="<?php echo base_url('application/modules/ordermanage2/assets/css/splitorder.css?v=1'); ?>">
                                    ...
                                    <tbody>
                                                    ...
                                                    foreach ($iteminfo as $item) {
                                                     ...
                                                     foreach($suborder_info as $menu_items){
                                                        if (!empty($menu_items->order_menu2_id)) {
                                                            
                                                            $suborder_data = unserialize($menu_items->order_menu2_id);
  ...
  <div class="col-md-6">
                                    <div class="info_part split-item" onclick="selectelement(this)" data-value="<?php echo $suborder->sub_id; ?>">
                                        ...
                                        <table class="table table-bordered table-modal table-info text-center" id="table-tbody-<?php echo $suborder->order_id;?>-<?php echo $suborder->sub_id;?>">
                                            ...
                                            <tbody>
                                            <?php $SD=0;
											if(!empty($suborder->order_menu2_id)){
                                                $suborderqty = unserialize($suborder->order_menu2_id);
                                               
                                                foreach ($suborder->suborderitem as $subitem) {
												$isoffer=$this->order_model->read('*', 'order_menu2', array('row_id' => $subitem->row_id));
                                                ...
                                                $isaddones=$this->order_model->read('*', 'check_addones2', array('order_menu2id' => $subitem->row_id));
                                    if(!empty($suborder->adons_id) && !empty($isaddones) ){
                                     ...
                                     $y++;
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo $subitem->variant2Name; ?></td>
                                                    <td>
