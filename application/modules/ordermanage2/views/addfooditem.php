    ...
    <div class="col-sm-12 col-md-12">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <?php echo form_open_multipart("ordermanage2/item_food/create") ?>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-12">
                        ...
                        <div class="form-group row">
                            ...
                            <label for="foodname" class="col-sm-4 col-form-label"><?php echo display('item_name2')?> <i class="text-danger"> *</i></label>
                        ...
                        <div class="form-group row">
                            ...
                            <label for="customqty"
                                ...
                                <label for="customqty"></label>
                                    <input type="number" name="customqty" max="" min="1" value="<?php echo (!empty($productinfo->customqty)?$productinfo->customqty:null) ?>"  id="customqty">
...
<script src="<?php echo base_url('application/modules/ordermanage2/assets/js/addfooditem_script.js'); ?>"
