...
class Foodavailable_model extends MX_Controller {
	...
	{
	   $this->db->select('foodvariable2.*,item_foods2.ProductName');
        $this->db->from($this->table);
		$this->db->join('item_foods2','foodvariable2.foodid = item_foods2.ProductsID','left');
