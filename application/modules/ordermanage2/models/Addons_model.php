...
class Addons_model extends CI_Model {
	...
	private $table = 'add_ons2';
	private $table2 = 'menu_add_on2';
  ...
  public function menuaddons_delete($id = null)
	...
	{
	    $this->db->select('menu_add_on2.*,item_foods2.ProductName,add_ons2.add_on_name');
        $this->db->from($this->table2);
		$this->db->join('item_foods2','menu_add_on2.menu_id = item_foods2.ProductsID','left');
		$this->db->join('add_ons2','menu_add_on2.add_on_id = add_ons2.add_on_id','inner');
