...
CREATE TABLE `customer_type2` (
  `customer_type2_id` int(11) NOT NULL AUTO_INCREMENT,
  `customer_type2` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `ordering` int(11) DEFAULT 0,
  PRIMARY KEY (`customer_type2_id`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `bill2` (
  `bill2_id` bigint(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `membership2` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `membership2_name` varchar(250) COLLATE utf8_unicode_ci NOT NULL,
  `discount` float NOT NULL,
...
CREATE TABLE IF NOT EXISTS `multipay_bill22` (
...
CREATE TABLE `variant2` (
  `variant2id` int(11) NOT NULL AUTO_INCREMENT,
  `menuid` int(11) NOT NULL,
  `variant2Name` varchar(120) NOT NULL,
  `price` decimal(10,2) NOT NULL DEFAULT 0.00,
  PRIMARY KEY (`variant2id`)
