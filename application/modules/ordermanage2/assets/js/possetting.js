...
$(document).ready(function(){
	...
	Mousetrap.bind('alt+a',function(){
		...
		/*print bill2 paid amount*/

	Mousetrap.bind('alt+p',function(){

		$('#pay_bill2').trigger( "click" );
	...
	$('.search-field').select2({
		...
		ajax: {
			...
			url: baseurl+'ordermanage2/order/getitemlistdroup',
				...
				return {
					...
					results:  $.map(data, function (item) {
						...
						return {
							...
							text: item.text+'-'+item.variant2Name,

							id: item.id+'-'+item.variant2id
...
function ongoingclick(){
	...
	var url= baseurl+"ordermanage2/order/getongoingorder";
...
$(document).on('click','#kitchenorder',function(){
	...
	var url= baseurl+"ordermanage2/order/kitchenstatus";
...
function todayorderclick(){
	...
	var url=baseurl+"ordermanage2/order/showtodayorder";
...
function todayonlieorderclick(){
	...
	var url=baseurl+"ordermanage2/order/showonlineorder";
...
$(document).on('click','#todayqrorder',function(){
	...
	var url= baseurl+"ordermanage2/order/showqrorder";
...
function ongoingtable_namesrc(){
	...
	var url= baseurl+"ordermanage2/order/getongoingorder"+"/"+id;
...
function ongoingtable_srch(){
	...
	var url= baseurl+"ordermanage2/order/getongoingorder"+"/"+id+"/table";
...
function productsrcname(){
	...
	var url= baseurl+"ordermanage2/order/srcposaddcart"+"/"+id;
	...
	$.ajax({
		...
		success: function(data) {
			...
			var myurl =baseurl+"ordermanage2/order/adonsproductadd"+'/'+id;
...
if(ctypeid==3){
	...
	if(errormessage==''){
		...
		$.ajax({
			...
			url: baseurl+"ordermanage2/order/pos_order",
...
function postokenprint(id){
	...
	var url= baseurl+"ordermanage2/order/paidtoken"+"/"+id+"/";
...
function editposorder(id,view){
	...
	var url= baseurl+"ordermanage2/order/updateorder"+"/"+id;
...
if(ctypeid==3){
	...
	if(errormessage==''){
		...
		$.ajax({
			...
			url: baseurl+"ordermanage2/order/pos_order/1",
			...
			function (isConfirm) {
				...
				if (isConfirm) {
					...
					$.ajax({
						...
						url: baseurl+"ordermanage2/order/postokengenerateupdate/"+result.orderid+"/1",
					...
					$.ajax({
						...
						url: baseurl+"ordermanage2/order/tokenupdate/"+result.orderid,
...
function payorderbill2(status,orderid,totalamount){

	$('#paidbill2').attr('onclick','orderconfirmorcancel('+status+','+orderid+')');
...
function orderconfirmorcancel(status,orderid){
	...
	$.ajax({
		...
		type: "POST",
			...
			url: baseurl+"ordermanage2/order/changestatus",//workingnow
			...
			success: function(data){
				...
				if(mystatus=="9"){
					...
					window.location.href=baseurl+"ordermanage2/order/orderinvoice/"+orderid;
...
function load_unseen_notification(view = ''){   
	...
	$.ajax({
		...
		url: baseurl+"ordermanage2/order/notification",
...
function load_unseen_notificationqr(view = ''){
	...
	$.ajax({
		...
		url: baseurl+"ordermanage2/order/notificationqr",
...
function detailspop(orderid){
	...
	var myurl=baseurl+'ordermanage2/order/orderdetailspop/'+orderid;
...
function pospageprint(orderid){
	...
	$.ajax({
		...
		url: baseurl+"ordermanage2/order/posprintview/"+orderid,
...
function printPosinvoice(id){
	...
	var url = baseurl+"ordermanage2/order/posorderinvoice/"+id;
...
function pos_order_invoice(id){
	...
	var url= baseurl+"ordermanage2/order/pos_order_invoice/"+id;
...
function orderdetails_post(id){
	...
	var url= baseurl+"ordermanage2/order/orderdetails_post/"+id;
...
function createMargeorder(orderid,value=null){
	...
	var url = baseurl+"ordermanage2/order/showpaymentmodal/"+orderid;
...
function addtomaininvoice(){
	...
	var url= baseurl+"ordermanage2/order/addtomaininvoice";
	...
	success: function(data) {
		...
		if (data != ''){
			...
			swal({
				...
				text: "bill2 is Added in Main Invoice !!",
...
$(document).on('click','#add_new_payment_type',function(){
	...
	var url= baseurl+"ordermanage2/order/showpaymentmodal/"+orderid+"/1";
...
function printmergeinvoice(id){
	...
	var url = baseurl+'ordermanage2/order/checkprint/'+id;
...
function submitmultiplepay(){
	...
	$.ajax({
		...
		url:baseurl+"ordermanage2/order/paymultiple",
...
function mergeorderlist(){
	...
	$.ajax({
		...
		url:baseurl+"ordermanage2/order/mergemodal",
...
function duemergeorder(orderid,mergeid){
	...
	$.ajax({
		...
		url: baseurl+"ordermanage2/order/duemergemodal",
...
function margeorderconfirmorcancel(){
	...
	$.ajax({
		...
		url: baseurl+"ordermanage2/order/changeMargeorder",
...
function duemargebill2(){
	...
	$.ajax({
		...
		url: baseurl+"ordermanage2/order/changeMargedue",
...
function checktable(id=null){
	...
	if(id !=null){
		...
		var url= baseurl+"ordermanage2/order/checktablecap/"+id;
		...
		var url= baseurl+"ordermanage2/order/checktablecap/"+idd;
...
function showTablemodal(){
	...
	var url = base+"ordermanage2/order/showtablemodal";
...
function showfloor(floorid){
	...
	var geturl=base+"ordermanage2/order/fllorwisetable";
...

{
	...
	if(tableid==null){
		...
		var url = base+"ordermanage2/order/delete_table_details2/"+id;
		...
		var url = base+"ordermanage2/order/delete_table_details2_all/"+tableid;
...
function update_product_namesrc(){
	...
	var url= base+'ordermanage2/order/addtocartupdate_uniqe'+'/'+id+'/'+updateid;
	...
	$.ajax({
		...
		success: function(data) {
			...
			var myurl =base+"ordermanage2/order/adonsproductadd"+'/'+id;
...
function showsplitmodal(orderid,option=null){
	...
	var url = base+"ordermanage2/order/showsplitorder/"+orderid;
...
function submitmultiplepaysub(subid){
	...
	$.ajax({
		...
		url: baseurl+"ordermanage2/order/paymultiplsub",
...
function showsplit(orderid){
	...
	var url = baseurl+'ordermanage2/order/showsplitorderlist/'+orderid;
...
function possubpageprint(orderid){
	...
	$.ajax({
		...
		url: baseurl+"ordermanage2/order/posprintdirectsub/"+orderid,
...
function addnotetoitem(){
	...
	var note=$("#foodnote2").val();

	var foodqty=$("#foodqty").val();

	var csrf = $('#csrfhashresarvation').val();

	var geturl=baseurl+'ordermanage2/order/additemnote';

	var dataString = "foodnote2="+note+'&rowid='+rowid+'&qty='+foodqty+'&csrf_test_name='+csrf;
...
function addnotetoupdate(){
	...
	var geturl=baseurl+'ordermanage2/order/addnotetoupdate';

	var dataString = "foodnote2="+note+'&rowid='+rowid+'&orderid='+orderid+'&group='+group+'&csrf_test_name='+csrf;
...
function opencashregister(){
	...
	$.ajax({
		...
		url: baseurl+"ordermanage2/order/addcashregister",
...
function closeopenresister(){
	...
	var closeurl=baseurl+"ordermanage2/order/cashregisterclose";
...
function closecashregister(){
	...
	$.ajax({
		...
		url: baseurl+"ordermanage2/order/closecashregister",
...
$(document).on('click', '#cancelreason', function(){ 
	...
	$.ajax({
		...
		url: baseurl+"ordermanage2/order/acceptnotify",
...
function newcastsubmit(){ 
	...
	var customer_type2 = $('#newcustomer_type2res').val();
	...
	if (customer_type2 == "newcust") {
		...
		if (customer_name != '' && mobile != '' && umobile_count == 0) {
			...
			$.ajax({
				...
				url: base+"ordermanage2/order/insert_customer",
				...
				success: function(data) {
					...
					$('#newcustomer_type2res').val(null).trigger('change');
	...
	else if (customer_type2 == "oldcust") {
...
function newcustdatares(){
	...
	var newcustomer_type2res = $('#newcustomer_type2res').val();

	

	if (newcustomer_type2res == "newcust") {
	...
	if (newcustomer_type2res == "oldcust") {
...
function oldcustdatalistrestaurent() {
	...
	$.ajax({
		...
		url: baseurl+"ordermanage2/order/check_registered_customer",
...
$('body').on('keyup', '#mobile', function(){
	...
	$.ajax({
		...
		url: baseurl+"ordermanage2/order/check_duplicate_customer",
