...
var url= baseurl+'ordermanage2/order/addtocartupdate_uniqe'+'/'+id+'/'+updateid;
/*check production*/
...
success: function(data) {
console.log("done");
window.location.href=baseurl+"ordermanage2/order/orderlist";
}
});
}
});
...
var myurl=baseurl+"ordermanage2/order/itemqtyupdate";
$.ajax({
type: "POST",
url: myurl,
data: dataString,
