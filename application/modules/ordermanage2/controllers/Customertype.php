...
class Customertype extends MX_Controller {
    ...
    public function index($id = null)
    {
        ...
        #pagination starts
        #
        $config["base_url"] = base_url('ordermanage2/customertype/index');
    ...
    public function create($id = null)
    {
	  ...
	  #-------------------------------#
	   ...
	   $data['type']   = (Object) $postData = array(
		   'customer_type2_id'  		=> $this->input->post('customer_type2_id'),
		   'customer_type2' 			=> $this->input->post('typename',true),
		  ); 
	  $data['intinfo']="";
	  if ($this->form_validation->run()) { 
	   if(empty($this->input->post('customer_type2_id'))) {
		...
		if ($this->customertype_model->create($postData)) { 
		 ...
		 redirect('ordermanage2/customer-type');
		} else {
   ...
   public function updateintfrm($id){
        ...
        $data['module'] = "ordermanage2";
        $data['page']   = "ctypedit";
		$this->load->view('ordermanage2/ctypedit', $data);
