...
class item_category2 extends MX_Controller {
    ...
    public function index()
    {
        ...
        #pagination starts
        #
        $config["base_url"] = base_url('ordermanage2/item_category2/index');
    ...
    public function create($id = null)
    {
	  ...
	  $this->form_validation->set_rules('categoryname', display('category_name')  ,'required|max_length[100]');
		   ...
		   $this->form_validation->set_rules('categoryname', display('category_name')  ,'required|is_unique[item_category2.Name]|max_length[100]');
		   $this->form_validation->set_message('is_unique', 'Sorry, this %s already used!');
		  }
	  $this->form_validation->set_rules('status', display('status')  ,'required');
	  $this->load->library('fileupload');
	  $img = $this->fileupload->do_upload(
		'./application/modules/ordermanage2/assets/images/','picture'
	 ...
	 $logData = array(
	   ...
	   'entry_date'          => date('Y-m-d H:i:s'),
		...
		if ($this->category_model->cat_create($postData)) { 
		 ...
		 redirect('ordermanage2/category-create');
		} else {
	  ...
	  $logData = array(
	   ...
	   'entry_date'          => date('Y-m-d H:i:s'),
		...
		redirect("ordermanage2/item_category2/create/".$postData['CategoryID']);
	   }
	  } else { 
	   if(!empty($id)) {
    ...
    public function delete($category = null)
    {
	   ...
	   'entry_date'          => date('Y-m-d H:i:s'),
		...
		redirect('ordermanage2/item_category2/index');
    }
