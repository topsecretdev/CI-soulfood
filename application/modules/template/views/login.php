                    ...
                    <div class="form-card mb-5">
                        ...
                        <div class="form-card_body">
                            ...
                            <div class="form-group">
                                ...
                                <label class="input-label font-weight-bold" for="inputEmail"><?php echo display("Username") ?></label>

                                <input type="text" name="email" autocomplete="off" id="inputEmail"

                                    placeholder="<?php echo display('username') ?>" required autofocus
                           ...
                           <div class="text-center mt-3">
                               ...
                               Powered By <a href="https://edrictech.com.ng" target="_blank">EdricTech</a>
