...
"use strict";
     var allordertable = $('#tallorder').DataTable({
		...
		"searching": true,
		  "processing": true,
            ...
            var allordertablereport = $('#tallorderreport').DataTable({
        responsive: true,
        paging: true,
		"language": {
			"sProcessing":     lang.Processingod,
		...
		"searching": true,
		  "processing": true,
				 "serverSide": true,
				 "ajax":{
					url :baseurl+"ordermanage/order/allorderreportlist",
					type: "post",
					"data": function ( data ) {
						data.csrf_test_name = $('#csrf_token').val();
    ...
    allordertablereport.on( 'draw', function () {
                $('[data-toggle="tooltip"]').tooltip();
              } );
});
"use strict";
...
function getreport(){
    ...
    //     return false;
    // }
    var myurl = baseurl+"ordermanage/order/allorderreportlist";
