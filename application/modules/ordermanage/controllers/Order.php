...
/*
	...
	public function pos_order($value=null){
		...
		$customerid= !empty($this->input->post('customer_name',true)) ? $this->input->post('customer_name',true) : '';
		...
		if ($this->form_validation->run()) { 
			...
			$customerid2=!empty($this->input->post('customer_name',true)) ? $this->input->post('customer_name',true) : '';
			...
			$customerinfo=$this->order_model->read('*', 'customerinfo', array('customerid' => !empty($this->input->post('customer_name',true)) ? $this->input->post('customer_name',true) : ''));
			...
			$data2=array(
				...
				'customer_id'			=>	!empty($this->input->post('customer_name',true)) ? $this->input->post('customer_name',true) : '',
    ...
    public function delete($id = null)
		...
		redirect('ordermanage/order/orderdetails/'.$orderid);
    ...
    public function restaurantreport(){
        ...
        $config["base_url"] = base_url('ordermanage/order/restaurant-report');
