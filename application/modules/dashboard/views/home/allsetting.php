                    ...
                    <div class="col-sm-9 p-15">
                        <div class="tab-content" id="v-pills-tabContent">
                            <div class="tab-pane fade show active" id="v-pills-user" role="tabpanel"
                                ...
                                <div class="form-group row">
                                    <label for="email" class="col-sm-2 gallery-inp-hi"><?php echo display('username') ?> <i
                                            class="text-danger"> * </i></label>
                                    <div class="col-sm-9">
                                        <input name="email" class="form-control" type="text"
                                            placeholder="<?php echo display('username') ?>" id="email" value="">
                                    </div>
                                </div>
                                <div class="form-group row">
                            ...
                            <div class="tab-pane fade" id="v-pills-menusetting" role="tabpanel"
                                ...
                                <br>
                                <div class="form-group text-right " id="top_upbtn">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input name="Menuurl" id="Menuurl" class="form-control" type="text"
                                                placeholder="<?php echo display('menu_url') ?>" >
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="category"
