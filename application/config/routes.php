...
$route['reports/booking-report-delete/(:num)'] = "reports/report/delete/$1";
...
$route['ordermanage/order-delete/(:num)'] = "ordermanage/order/delete/$1";

$route['ordermanage/restaurant-report'] = "ordermanage/order/restaurantreport";
...
$route['ordermanage2/category-create'] = "ordermanage2/item_category2/create";

$route['ordermanage2/category-list'] = "ordermanage2/item_category2/index";

$route['ordermanage2/food-create'] = "ordermanage2/item_food/create";

$route['ordermanage2/food-stock'] = "ordermanage2/item_food/food_stock";

$route['ordermanage2/food-list'] = "ordermanage2/item_food/index";

$route['ordermanage2/restaurant-report'] = "ordermanage2/order/restaurantreport";
...
$route['ordermanage2/food-groop-create'] = "ordermanage2/item_food/addgroupfood";

$route['ordermanage2/food-varient-list'] = "ordermanage2/item_food/foodvarientlist";

$route['ordermanage2/food-available-list'] = "ordermanage2/item_food/availablelist";

$route['ordermanage2/today-menu-type'] = "ordermanage2/item_food/todaymenutype";

$route['ordermanage2/menu-addons-create'] = "ordermanage2/menu_addons/create";

$route['ordermanage2/menu-addons-list'] = "ordermanage2/menu_addons/index";

$route['ordermanage2/assign-menu-addons'] = "ordermanage2/menu_addons/assignaddons";



// Order Management

$route['ordermanage2/pos-invoice'] = "ordermanage2/order/pos_invoice";

$route['ordermanage2/order-list'] = "ordermanage2/order/orderlist";

$route['ordermanage2/order-delete/(:num)'] = "ordermanage2/order/delete/$1";

$route['ordermanage2/pending-order'] = "ordermanage2/order/pendingorder";

$route['ordermanage2/complete-list'] = "ordermanage2/order/completelist";

$route['ordermanage2/cancel-list'] = "ordermanage2/order/cancellist";

$route['ordermanage2/kitchen'] = "ordermanage2/order/kitchen";

$route['ordermanage2/counter-board'] = "ordermanage2/order/counterboard";

$route['ordermanage2/home'] = "ordermanage2/order/home";

$route['ordermanage2/counter-list'] = "ordermanage2/order/counterlist";

$route['ordermanage2/pos-setting'] = "ordermanage2/order/possetting";

$route['ordermanage2/sound-setting'] = "ordermanage2/order/soundsetting";



$route['ordermanage2/table-list'] = "ordermanage2/restauranttable/index";

$route['ordermanage2/table-setting'] = "ordermanage2/restauranttable/tablesetting";

$route['ordermanage2/customer-type'] = "ordermanage2/customertype/index";

$route['ordermanage2/card-terminal'] = "ordermanage2/card_terminal/index";
